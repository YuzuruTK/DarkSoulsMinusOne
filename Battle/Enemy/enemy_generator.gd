...
const BASE_STATS = {
	EnemyType.WOLF: {"max_h": 15, "atk_dam": 3, "init_range": [2, 4]}, # Aggressive brute - HP increased
	EnemyType.BIRD: {"max_h": 12, "atk_dam": 2, "init_range": [3, 9]}, # Fast annoyance - HP & damage increased
	EnemyType.HOG: {"max_h": 18, "atk_dam": 2, "init_range": [1, 4]}, # Tanky slow beast - HP & damage increased
	EnemyType.SKELETON: {"max_h": 17, "atk_dam": 2, "init_range": [3, 9]}, # Agile and smart - HP increased
	EnemyType.SOLDIER: {"max_h": 20, "atk_dam": 2, "init_range": [1, 5]}, # Tactical, average all - HP increased
	EnemyType.PHANTASM: {"max_h": 14, "atk_dam": 2, "init_range": [1, 5]}, # Magic-like threat - HP increased
	EnemyType.ALIEN: {"max_h": 19, "atk_dam": 3, "init_range": [1, 3]}, # High damage threat - HP increased
	EnemyType.TIGER: {"max_h": 15, "atk_dam": 4, "init_range": [6, 12]}, # Ambusher - HP & damage increased
}
